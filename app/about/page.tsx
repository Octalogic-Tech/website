      ...
      <div className="sm:mx-4 sm:my-8 md:mx-16 md:my-12 lg:ml-28 lg:mr-28 xl:mt-21 xl:mb-21">
        ...
        <div className="flex max-w-[86rem] mx-0 my-8 sm:flex sm:flex-col-reverse md:flex md:flex-row">
          <div className="flex-none md:w-3/5 ">
            <Paragraph
              className={`max-w-[45rem]  sm:text-[1.4rem]  md:text-[1.2rem] xl:text-[1.4rem]`}
            >
            ...
            <Paragraph
              className={`max-w-[45rem] mt-8 sm:text-[1.4rem] md:text-[1.2rem] lg:mb-[3rem] xl:text-[1.4rem]`}
            >
            ...
            <Paragraph className={`mt-5 max-w-[45rem] text-base sm:text-xl`}>
