...
export default function NotScopeSection({ data }: NotScopeSectionProps) {
  return (
    <section className="flex min-h-[100vh] w-full flex-col items-center justify-center bg-black px-4 py-16 text-white md:px-32 md:py-8">
