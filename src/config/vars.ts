...
export const turnstileEndpoint: string =
...
export const emailApiKey: string = process.env.NEXT_EMAIL_API_KEY as string;
export const notificationEmail: string = process.env.NEXT_NOTIFICATION_EMAIL as string;
