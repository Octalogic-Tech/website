...
const commonCspDirectives = [
  ...
  "object-src 'none'",
  "child-src www.googletagmanager.com *.facebook.com connect.facebook.net blob:",
  "manifest-src 'self'",
